...
function getToken() {
	return new Promise(function(resolve, reject) {
		...
		if (!token || token.timeout < Date.now()) {
			https.get("https://api.weixin.qq.com/cgi-bin/token?grant_type=client_credential&appid=wx25dfc64551d76d6f&secret=295a8f560efdaa8867034d19f189f7b9", function(res) {
    			var html = ''; // 保存抓取
...
var clientServer = app.listen(3000, function () {
...
wxserver.listen(9901);
console.log("WxServer running at port:9901!");
